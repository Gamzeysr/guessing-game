...
//         msg.innerHTML = `Congrats You Win <i class="fa-solid fa-face-grin-hearts f
...
//         ? (msg.innerHTML = `< i class="fa-solid fa-arrow-trend-down fa-2x" ></i >
//         : (msg.innerHTML = `<i class="fa-solid fa-arrow-trend-up fa-2x"></i> I
//     } else {
//       msg.innerHTML = `You Lost < i class="fa-regular fa-face-sad-tear fa-2x" > <
//             document.querySelector(".secret-number").textContent = randomNumber;
